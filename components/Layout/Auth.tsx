    ...
    <div>
      <div className="layout">
        <div className="navbar">
          <a href="/">
            <img src="/images/logo.png" width="66px" height="80px" alt="perdosi logo" />
          </a>
          <ul className="menu">
